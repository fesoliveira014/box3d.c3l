...
Status: early. Worlds, bodies, the sphere, capsule and convex-hull shapes, and the world's event
arrays are bound; the rest of the API surface follows incrementally.
